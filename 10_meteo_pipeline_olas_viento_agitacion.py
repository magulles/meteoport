...
def main():
    ...
    copernicus_points = download_copernicus_wave_data(offshore_points) if offshore_points else []
    pde_points = download_pde_wave_data(offshore_points) if offshore_points else []
    wind_points = download_wind_data(offshore_points) if offshore_points else []

    agitation_points = download_port_agitation(port_points) if port_points else []
