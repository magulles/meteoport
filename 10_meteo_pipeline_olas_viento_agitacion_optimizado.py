...
MAX_WORKERS_PDE = int(os.getenv("METEOPORT_MAX_WORKERS_PDE", "6"))
MAX_WORKERS_PORT = int(os.getenv("METEOPORT_MAX_WORKERS_PORT", "6"))
MAX_WORKERS_TOP_LEVEL = int(os.getenv("METEOPORT_MAX_WORKERS_TOP_LEVEL", "4"))
...
def get_pde_region_inventory() -> Dict[str, Dict]:
    cache_key = "pde_region_inventory.json"
...
def get_port_mesh_inventory() -> Dict[str, Dict]:
    cache_key = "port_mesh_inventory.json"
    cached = load_json_cache(cache_key)
    if cached:
        return cached
