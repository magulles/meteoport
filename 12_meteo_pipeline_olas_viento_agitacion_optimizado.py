...
MAX_WORKERS_PDE = int(os.getenv("METEOPORT_MAX_WORKERS_PDE", "4"))
MAX_WORKERS_PORT = int(os.getenv("METEOPORT_MAX_WORKERS_PORT", "2"))
MAX_WORKERS_TOP_LEVEL = int(os.getenv("METEOPORT_MAX_WORKERS_TOP_LEVEL", "3"))
MAX_WORKERS_COPERNICUS = int(os.getenv("METEOPORT_MAX_WORKERS_COPERNICUS", "4"))
